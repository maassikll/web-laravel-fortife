    ...
    <body>
                    ...
                    <div class="row">
                        ...
                        <div class="main-team-card d-flex">
                            ...
                            <div class="team-setup">
                                <div class="team-items">
                                    <div class="team-user">
                                    <img src="{{asset('assets/images/team/3.jpg')}}">
                                    </div>
                                    <div class="team-user-social">
                                    <ol>
                                        <li><i class="flaticon-facebook"></i></li>
                            ...
                            <div class="team-setup">
                                <div class="team-items">
                                    <div class="team-user">
                                    <img src="{{asset('assets/images/team/4.jpg')}}">
                                    </div>
                                    <div class="team-user-social">
                                    <ol>
                                        <li><i class="flaticon-facebook"></i></li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="wrapper">
                            ...
                            <div class="form-group">
                                <input class="form-control" placeholder="Enter Your Email" role="text" name="email" type="email">
        ...
        <div class="copy-right">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p>2020 @ All Rights Reserved Designed and developed by<a href="https://www.smarteyeapps.com">smarteyeapps</a></p>
                    </div>
                </div>
            </div>
        </div>
